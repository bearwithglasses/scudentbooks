...
$sql2 = "SELECT * FROM Subject WHERE userid1 = '$useridCreator' OR userid2 = '$useridCreator'";
...
<div class="inboxfilters">
    ...
    <a href="inbox.php?username=<?php echo $_SESSION['username'] ?>" id="activated" class="minorbutton inboxfilterbutton">Newest to Oldest</a>
    ...
    <?php
        ...
        while ($row2 = oci_fetch_array($stid2, OCI_ASSOC+OCI_RETURN_NULLS))
        {
            ...
            // echo "<input type='hidden' id='subjectDate' name='subjectDate' value=".$subjectDate.">";
            // echo "<input type='hidden' id='userid' name='userid' value=".$messageUser.">";
